...
|[PriPL-Tree: Accurate Range Query for Arbitrary Distribution under Local Differential Privacy](https://www.vldb.org/pvldb/vol17/p3031-wang.pdf)|Leixia Wang, Qingqing Ye, et al|2024 VLDB Endow|针对数据分布不均匀导致估计不准确的问题，本文引入了新颖的PriPL-Tree结构，将分层树结构和分段线性函数相结合，以回答任意分布的范围查询，并将其扩展到具有新颖数据感知自适应网格的多维情况。 <br> - 实验代码：https://github.com/leixiawang/priplt <br> - ☑️ 组内汇报：
...
|[On the Risks of Collecting Multidimensional Data Under Local Differential Privacy.](https://www.vldb.org/pvldb/vol16/p1126-arcolezi.pdf)|	Héber Hwang Arcolezi |2023/VLDB Endow|本文基于两种最先进的多属性频率估计解决方案，研究了针对多维数据LDP协议的隐私威胁（重新识别和属性推理攻击），并提出了一种提高针对已识别威胁的效用和鲁棒性的对策. <br> - 实验代码：https://github.com/hharcolezi/risks-ldp <br> - ☑️ 组内汇报：
