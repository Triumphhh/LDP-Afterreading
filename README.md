...
| Webank | 微众银行的多方大数据隐私计算平台，解决大模型推理过程中隐私泄露风险较高的问题：基于预测损失对答案预测模型以及编码器进行迭代更新的步骤包括：计算预测损失对答案预测模型的第一梯度以及预测损失对编码器的第二梯度；对第二梯度进行差分隐私处理，得到第三梯度；基于第一梯度对答案预测模型进行迭代更新，并基于第三梯度对编码器进行迭代更新。 | 来源：https://www.mpaypass.com.cn/news/202406/19120626.html
